...
function get20s(array){
  ...
  for (let i=0; i<array.length; i++){
    if (array[i].years.slice( 0, 4) >= 1900 && array[i].years.slice( 6, 11) < 2000){
...
function addArtist(array){
    array.push({
      ...
      bio: "Michael McFadden is an up and coming wed developer ready to shock the world with his sick skills."
    })
    return array;
  }
